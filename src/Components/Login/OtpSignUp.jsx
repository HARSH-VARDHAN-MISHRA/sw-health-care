...
const OtpSignUp = () => {
    ...
    const handleResendOtpSubmit = async (otpevent) =>{
        ...
        try {
            ...
            const response = await axios.post("https://api.swhealthcares.com/api/v1/resend-sign-Otp",formData)
    ...
    const handleOtpSubmit = async (otpevent) =>{
        ...
        try {
            console.log(formData)
            const response = await axios.post("https://api.swhealthcares.com/api/v1/Verify-sign-Otp",formData)
