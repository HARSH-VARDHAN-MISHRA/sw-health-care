...
const ForgetPassword = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("https://api.swhealthcares.com/api/v1/Password-change-request", formData)
    ...
    const handleOTPSubmit = async (otpevent) => {
        ...
        try {
            const response = await axios.post(`https://api.swhealthcares.com/api/v1/Verify-Otp/${formData.email}/${formData.newPassword}`, formData)
            console.log(response.data);
            setLoading(false);
            toast.success(response.data.msg)
    ...
    const resendOTP = async (otpevent) => {
        ...
        otpevent.preventDefault()
        try {
            const response = await axios.post(`https://api.swhealthcares.com/api/v1/Resend-Otp/`, formData)
            console.log(response.data);
            setLoading(false);
