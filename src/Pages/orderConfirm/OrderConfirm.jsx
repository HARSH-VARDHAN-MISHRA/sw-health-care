...
const OrderConfirm = () => {
    const orderData = JSON.parse(sessionStorage.getItem('swcart'));
    const userData = JSON.parse(sessionStorage.getItem('swUser'));
                        ...
                        <div className="bordered-box">
                                ...
                                <div className="row table-inner">
                                    <div className="col-md-6">
                                        ...
                                        <p>{userData[0].name || "N/A"}</p>
                                        <p>{userData[0].email || "N/A"}</p>
